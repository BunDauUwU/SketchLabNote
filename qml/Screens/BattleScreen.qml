...
Rectangle {
    ...
    property int opponentElementPoints: (gameManager && gameManager.board && gameManager.board.opponentPlayer) ? gameManager.board.opponentPlayer.elementPoints : 10
    property int opponentMaxElementPoints: (gameManager && gameManager.board && gameManager.board.opponentPlayer) ? gameManager.board.opponentPlayer.maxElementPoints : 10
    property string activeWeather: (gameManager && gameManager.board) ? gameManager.board.weatherName : "Rain"
    property string weatherDescription: (gameManager && gameManager.board) ? gameManager.board.weatherDescription : "Battlefield condition placeholder. Logic hooks can fill this from snapshots later."
