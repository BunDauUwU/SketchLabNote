        ...
        Column {
            ...
            Repeater {
                ...
                Image {
                    width: 29;
                    height: 29;
                    source: "/lumieTcg/assets/elements/omni.png";
            ...
            Repeater {
                ...
                Rectangle {
                    ...
                    Image {
                        ...
                        opacity: modelData.defeated ? 0.35 : 1
                    }
                    ...
                    MouseArea {
                        anchors.fill: parent
                        onDoubleClicked: {
                            if (index !== root.activeIndex && !modelData.defeated) {
                                gameManager.switchCharacter(index)
                                selfPlayer.elementPoints.current -= 1
                            }
                        }
                    }
                }
                            ...
                            onClicked: {
                                ...
                                if (root.pendingCard === index) {
                                    if (cost <= selfPlayer.elementPoints.current) {
                                        ...
                                        selfPlayer.elementPoints.current -= cost
                                    }
                                    root.cancelPreview()
                                } else {
